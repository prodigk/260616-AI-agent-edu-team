...
- `db/`: 7개 코어 CSV와 보조 분석 CSV fixture 데이터

## 3. 사용 데이터

현재 대시보드는 7개 코어 CSV와 보조 분석 CSV를 사용합니다.
...
- 현재 코어/보조 CSV와 기존 분석 결과만으로도 구현 가능한 기능
...
- CSV fixture는 데이터 구조를 바꿀 때 앱 로딩/분석 계약을 함께 맞춰야 함
